...
create_generated_clock -name mspi_clk -source [get_ports {clk}] -master_clock clk -divide_by 7 -multiply_by 2 -duty_cycle 50 -phase 180 [get_nets {mspi_clk}]
create_generated_clock -name flash_clk -source [get_ports {clk}] -master_clock clk -divide_by 7 -multiply_by 2 [get_nets {flash_clk}]
